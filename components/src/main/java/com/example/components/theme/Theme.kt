...
private val LocalColors = staticCompositionLocalOf<JustColors> {
    error("No JustCookColorPalette provided")
}
...
private val LightColorPalette = JustColors(
    brand = Shadow5,
    ...
    error = FunctionalRed,
    gradientGold = listOf(Gold1, Gold2),
...
private val DarkColorPalette = JustColors(
    brand = Shadow1,
    ...
    gradientGold = listOf(Gold3, Gold4),
...
object JustCookColorPalette {
    val colors: JustColors
        @Composable
        get() = LocalColors.current
}

@Immutable
data class JustColors(
